...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row w-full">
      ...
      <div className={`flex-1 bg-gradient-to-br from-soft-cream to-cream-gradient px-6 md:px-10 py-12 flex flex-col justify-center relative transition-all duration-1000 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`}>
      ...
      <div className={`flex-1 bg-deep-teal px-6 md:px-10 py-12 flex flex-col justify-between text-soft-cream relative transition-all duration-1000 delay-300 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`}>
        {/* Header Section */}
        <div>
          {/* Navigation */}
          <nav className="mb-8">
